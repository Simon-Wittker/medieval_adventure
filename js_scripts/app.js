...
function start_game() {
    ...
    // config the body
    document.getElementsByTagName('body')[0].style.backgroundColor = "rgb(0, 100, 150)";
...
function start_Game(monster_number) {
    ...
    if (window.innerWidth < 1250){
        splash_screen_div.style.width = (window.innerWidth - 60).toString() + "px";
    } else {
        splash_screen_div.style.width = "1230px";
        splash_screen_div.style.left = ((window.innerWidth - 1230) / 2).toString() + "px";
    }
    ...
    let splash_screen_bottom_div  = document.createElement("div");
    splash_screen_bottom_div.style.id = "splash_screen_bottom_div";
    splash_screen_bottom_div.style.height = "10%";
    splash_screen_bottom_div.style.width = "98%";
    splash_screen_bottom_div.style.display = "flex";
    splash_screen_bottom_div.style.alignItems = "center";
    splash_screen_bottom_div.style.justifyContent = "center";
    splash_screen_div.appendChild(splash_screen_bottom_div);
    ...
    splash_screen_process_bar_div.style.height = "24px";
    ...
    splash_screen_process_bar_div.innerHTML = "<p> Spiel ladet ... </p>";
    splash_screen_bottom_div.appendChild(splash_screen_process_bar_div);
    ...
    help_div.style.backgroundColor = "rgb(0, 100, 150)";
    ...
    scene.background = new THREE.TextureLoader().load("../../images/sky_1.png");
