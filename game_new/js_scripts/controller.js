...
export class Controller {
    ...
    splash_screen_handler(){
        ...
        let interval = setInterval(function () {
            ...
            document.getElementById('splash_screen_process_bar').style.width = width + '%'; // TODO --> beim 2. Mal starten bleibt der progress-bar 0 obwohl width ++
            if (width >= 100) {
                clearInterval(interval);
                // Hide the progress bar and show the button after a delay
                setTimeout(function () {
                    //document.getElementById('splash_screen_process_bar').style.display = 'none';
                    ...
                    document.getElementById('splash_screen_process_bar').style.width = "0";
