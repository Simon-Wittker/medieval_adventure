...
const image_url = '../../game_new/images/castel_on_a_hill.png';
const splash_screen_url_1 = '../../game_new/images/image_1.png';
const splash_screen_url_2 = '../../game_new/images/image_2.png';
const splash_screen_url_3 = '../../game_new/images/image_3.png';
const splash_screen_url_4 = '../../game_new/images/image_4.png';
...
secondary_div.style.height = "900px";
...
function start_Game(monster_number) {
    ...
    splash_screen_div.style.top = "0";
    splash_screen_div.style.right = "0";
    ...
    splash_screen_image_div.style.height = "85%";
    splash_screen_image_div.style.width = "100%";
    ...
    splash_screen_img.style.height = "95%";
    splash_screen_img.style.width = "95%";
    ...
    splash_screen_image_right_div.style.width = "80%";
    ...
    splash_screen_img_keyboard.style.width = "70%";
    splash_screen_img_keyboard.style.marginTop = "12%";
    ...
    end_div.innerHTML =
        ...
        "<label>Getötete Spinnen: </label><label id='killed_spiders'></label><label> / </label><label id='max_spiders'></label> <br>" +
        "<label>Getötete Wespen: </label><label id='killed_wasps'></label><label> / </label><label id='max_wasps'></label> <br>" +
        "<label>Getötete Ratten: </label><label id='killed_rats'></label><label> / </label><label id='max_rats'> </label> <br>" +
        "<label>Getötete Skelette: </label><label id='killed_skeletons'></label><label> / </label><label id='max_skeletons'></label> <br>" +
        "<label>Getötete Frösche: </label><label id='killed_frogs'></label><label> / </label><label id='max_frogs'></label> " +
        "<br> <br>";
